...
const EducatorLanding = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden" style={gradientBg}>
        ...
        >
          <h1
            className="text-6xl sm:text-7xl md:text-8xl font-black font-display tracking-tighter mb-4 leading-none"
            style={{
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden" style={gradientBg}>
      ...
      >
        <h1
          className="text-7xl sm:text-8xl md:text-9xl font-black font-display tracking-tighter mb-3 leading-none"
          style={{
            background: 'linear-gradient(135deg, hsl(211 60% 28%) 0%, hsl(197 65% 45%) 40%, hsl(45 80% 55%) 100%)',
            WebkitBackgroundClip: 'text',
            WebkitTextFillColor: 'transparent',
      ...
      >
        <div className="rounded-2xl border border-border/60 bg-card/70 backdrop-blur-md shadow-card overflow-hidden">
              ...
              <div className="grid grid-cols-3 gap-2.5">
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Month"
                    className="w-full h-11 pl-8 pr-2 rounded-xl border border-border bg-background/80 text-sm text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-secondary/30 focus:border-secondary/40 transition-all"
                  />
                </div>
                <input
                  type="text"
                  ...
                  placeholder="Day"
                  className="w-full h-11 px-3 rounded-xl border border-border bg-background/80 text-sm text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-secondary/30 focus:border-secondary/40 transition-all text-center"
                />
                <input
                  type="text"
                  value={year}
