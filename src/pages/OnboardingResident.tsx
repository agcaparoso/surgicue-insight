    ...
    <div className="min-h-screen page-gradient p-6">
      ...
      <div className="mb-8 max-w-md mx-auto">
        <div className="h-1.5 w-full bg-border rounded-full mb-4">
          <div className="h-full w-1/2 bg-secondary rounded-full transition-all" />
        </div>
        <p className="text-[10px] font-bold text-secondary uppercase tracking-widest mb-1">Step 1 of 2</p>
        <h2 className="text-2xl font-bold text-primary font-display">Set up your trainee profile</h2>
      </div>
